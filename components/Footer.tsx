    ...
    <div className="grid md:grid-cols-4 gap-8 md:gap-12 lg:gap-16 mb-12">
      ...
      <div>
        ...
        <p className="text-gray-400 text-sm leading-relaxed mb-6">
          Empowering businesses with modern retail solutions. We&apos;re committed to your success.
        </p>
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li>
            <a href="#inventory" className="text-gray-400 hover:text-white transition-colors duration-300">
              Inventory Management
            </a>
          </li>
          <li>
            <a href="#pos" className="text-gray-400 hover:text-white transition-colors duration-300">
              POS Systems
            </a>
          </li>
          <li>
            <a href="#analytics" className="text-gray-400 hover:text-white transition-colors duration-300">
              Analytics & Reporting
            </a>
          </li>
          <li>
            <a href="#consultation" className="text-gray-400 hover:text-white transition-colors duration-300">
              Consultation
            </a>
          </li>
          <li>
      ...
      <div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <a href="mailto:hello@retailbusiness.com" className="text-gray-300 hover:text-white transition-colors duration-300">
              hello@retailbusiness.com
            </a>
          </div>
          <div>
            <p className="text-gray-400 text-sm mb-1">Phone</p>
            <a href="tel:+1-800-555-0123" className="text-gray-300 hover:text-white transition-colors duration-300">
              +1 (800) 555-0123
            </a>
          </div>
          <div>
